...
Button
 ...
 Key1: Mouse Button 2
 Key2: None
 Pressed:  ctl_bSecFire = 1;
 Released: ctl_bSecFire = 0;
Button
 Name: TTRS Reload
 Key1: R
 Key2: None
...
Button
 ...
 Released: ctl_bUse = 0;
Button
 Name: TTRS Toggle ready
 Key1: F3
 Key2: None
 Pressed:  ctl_bReady = 1;
 Released: ctl_bReady = 0;
Button
 Name: TTRS Talk
 Key1: Y
 Key2: None
...
Button
 Name: TTRS Last weapon
 Key1: None
 Key2: None
 Pressed:  ctl_bWeaponLast = 1;
 Released: ctl_bWeaponLast = 0;
Button
...
Button
 Name: TTRS Plasmathrower/Minelayer
 Key1: 9
 Key2: None
